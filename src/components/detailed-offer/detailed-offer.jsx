...
import {offerShape, cityShape, MAP_SIZE_DETAILED_OFFER, MAX_OFFERS_NEARBY, commentShape, PlaceCardType, AuthorizationStatus} from '../../const.js';
import {getRatingInPercent} from '../../utils.js';
import {getCity} from '../../reducer/app/selectors.js';
import {getCommentsList, getAllOffersTransformed, getOffersNearby} from '../../reducer/data/selectors.js';
